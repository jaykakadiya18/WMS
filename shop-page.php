...
<body>
    ...
    <header>
        ...
        <nav class="navbar navbar-dark navbar-expand-lg header">
            <div class="container p-0"><h2>WMS</h2>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="nav navbar-nav ml-auto mobilemenu">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#contact">CONTACT TO SELLER</a>
                        </li>
    ...
    <!-- MAIN START -->
    <main class="main">
        <div class="shoppage-banner text-left">
            <div class="footer-part">
                <div class="container pl-0">
                    <center><h1 class="heading-three">Products Availeble in Warehouse</h1><br><br><br></center><center><h1>0% Comission</h1></center>
                </div>
            </div>
        </div>
        <div class="blog-part paddingub">
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-xl-3 col-xs-12 px-0 order-2 order-md-2 order-lg-1 wid pl-lg-3 pl-xl-0">
                            ...
                            <div class="sidebar-content">
                                <div class="sidebar-category sidebar-default">
                                    <div class="category-content searching">
                                        <input type="text" name="name" placeholder="Search text...">
                                    ...
                                    <div class="category-content">
                                        <div class="cat-detail">
                                            ...
                                            <ul class="cat-grp pl-0 mb-0">
                                                <li class="cat-item"><a href="#" class="cat-link">Cooking</a></li>
                                                <li class="cat-item"><a href="#" class="cat-link">Delicious</a></li>
                                                <li class="cat-item"><a href="#" class="cat-link">Fry Types</a></li>
                                                <li class="cat-item"><a href="#" class="cat-link">Recipes</a></li>
                                                <li class="cat-item"><a href="#" class="cat-link">Starters</a></li>
                                                <li class="cat-item mb-0"><a href="#" class="cat-link">Cooked</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-xs-12 col-xl-9 col-lg-8 pad order-1 order-md-1 order-lg-2 p-0 pr-lg-3 pr-xl-0">
                        <div class="container">
                            <div class="row">
                                <div class="col-xs-12 col-md-6 pl-20">
                                    <span class="show-result d-none d-md-block">Showing 1-09 of 10 results</span>
                                </div>
                                <div class="col-xs-12 col-md-6 pl-20">
                            ...
                            <div class="row text-center">
                                <div class="col-xs-12 col-sm-4  col-lg-4 img-box p-lg-0">
                                    <div class="hov">
                                        <a href="#" class="shop-img img-box">
                                            <img src="image/product-img1.jpg" class="prod-img" alt="product-img">
                                        </a>
                                        
                                    </div>
                                    <div class="detail">
                                        <a href="#"><h3 class="product-title w-100">Canvas Unisex T-Shirt</h3></a>
                                        <p><span>INR 55.40</span>&nbsp;&nbsp;INR 30.40</p>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-4 col-lg-4 img-box p-lg-0">
                                    <div class="hov">
                                        <a href="#" class="shop-img img-box">
                                            <img src="image/product-img2.jpg" class="prod-img" alt="product-img">
                                        </a>
                                ...
                                <div class="col-xs-12 col-sm-4 col-lg-4 img-box p-lg-0">
                                    <div class="hov">
                                        <a href="#" class="shop-img img-box">
                                            <img src="image/product-img3.jpg" class="prod-img" alt="product-img">
                                        </a>
                                ...
                                <div class="col-xs-12 col-sm-4 col-lg-4 img-box p-lg-0">
                                    <div class="hov">
                                        <a href="#" class="shop-img img-box">
                                            <img src="image/product-img4.jpg" class="prod-img" alt="product-img">
                                        </a>
                                ...
                                <div class="col-xs-12 col-sm-4 col-lg-4 img-box p-lg-0">
                                    <div class="hov">
                                        <a href="#" class="shop-img img-box">
                                            <img src="image/product-img5.jpg" class="prod-img" alt="product-img">
                                        </a>
                                ...
                                <div class="col-xs-12 col-sm-4 col-lg-4 img-box p-lg-0">
                                    <div class="hov">
                                        <a href="#" class="shop-img img-box">
                                            <img src="image/product-img6.jpg" class="prod-img" alt="product-img">
                                        </a>
                                ...
                                <div class="col-xs-12 col-sm-4 col-lg-4 img-box p-lg-0">
                                    <div class="hov">
                                        <a href="#" class="shop-img img-box">
                                            <img src="image/product-img7.jpg" class="prod-img" alt="product-img">
                                        </a>
                                ...
                                <div class="col-xs-12 col-sm-4 col-lg-4 img-box p-lg-0">
                                    <div class="hov">
                                        <a href="#" class="shop-img img-box">
                                            <img src="image/product-img8.jpg" class="prod-img" alt="product-img">
                                        </a>
                                ...
                                <div class="col-xs-12 col-sm-4 col-lg-4 img-box p-lg-0">
                                    <div class="hov">
                                        <a href="#" class="shop-img img-box">
                                            <img src="image/product-img9.jpg" class="prod-img" alt="product-img">
                                        </a>
    ...
    <script type="text/javascript">//index & aboutus : number count aimation
if($("#counter").length>0){
var a = 0;
...
.banner-detail .banner-title{font-size: 72px;color: #fff;font-family: 'Roboto Slab', serif;font-weight: 800;margin-bottom: 0px;}
...
.causes-part .cause-detail .causes-title{font-size: 16px;font-weight: 600;font-family: 'Roboto Slab';margin-bottom: 5px!important;display: inline-block;}
...
.causes-part .cause-detail .raised .pay-label{font-size: 14px;font-family: 'Roboto Slab';color: #10cb7f;font-weight: 600;margin-bottom: 20px;}
...
.blog-part .sidebar-content .cat-detail .cat-title{color: #231f20;font-size: 18px;font-weight: 600;display: inline-block;margin-bottom: 15px;font-family: 'Roboto Slab';} 
...
.blog-part .sidebar-content .sidebar-category .category-title .cate-heading{font-size: 18px;font-family: 'Roboto Slab';font-weight: 600;color:#231f20;padding: 17px 30px 16px 30px;display: inline-block;}
...
.blog-detail .blog-head-two{font-size: 24px;color:#2a2b2c;font-weight:700;font-family: 'Roboto Slab';}
.blog-detail .blog-head-two:hover{color: #ff6d0d;}
...
.recent-post .recent-detail .post-title{font-size: 14px;color: #111;font-weight: 500;font-family: 'Roboto Slab';margin-bottom: 0;}
...
.cause-detail .cause-head-two{font-size: 40px;color: #111;font-family: 'Roboto Slab';font-weight: 700;margin-bottom: 18px;}
.cause-detail.pr-100 .raised.float-right{margin-right: 140px;}
.cause-detail .raised .pay-label{font-size: 14px;font-family: 'Roboto Slab';color: #10cb7f;font-weight: 600;margin-bottom: 20px;}
.cause-detail .raised .money{font-size: 14px;color: #999;font-weight: 400;font-family: 'Open Sans';}
.cause-detail .donate{color: #fff;background-color:#ff6d0d;padding:14px 31px 15px 30px;display: inline-block;font-size: 14px;font-weight: 500;text-decoration: none;position: absolute;bottom: 0;right: 0;margin-right: 15px;}
...
.cause-detail .cause-head-three{font-size: 30px;color:#111;font-weight: 700;margin-bottom: 20px;font-family:'Roboto Slab';}
...
.cause-detail .note-p span{font-family: 'Roboto Slab';color:#111;font-size: 16px;}
.cause-detail .cause-head-four{font-size: 28px;font-family:'Roboto Slab';font-weight: 700;margin-bottom: 20px;}
...
.cause-detail .comment-submit{color:#fff;background-color:#10cb7f;padding: 13px 44px;display: inline-block;font-weight: 600;font-family:'Roboto Slab';}
...
.blog-part .product-title,.blog-part .show-result{font-size: 16px;font-family:'Roboto Slab';color:#231f20;font-weight: 600;display: inline-block;float: left;padding-top: 12px;}
...
.blog-part .img-box:hover .detail .product-title.w-100{color:#ff6d0d;cursor: pointer;text-decoration: none;}
...
.blog-part .form-group select.form-control{-webkit-appearance: none;background: url(../image/sorting-img.png) no-repeat;background-position:161px 15px;font-size: 15px;font-family:'Roboto Slab';color:#999;border-radius:0;}
...
.education-part .edu-data .edu-head-two{font-size: 40px;font-weight: 700;color:#111;font-family:'Roboto Slab';margin-top: 35px;margin-bottom: 15px;}
.education-part .edu-data .edu-p{font-size: 14px;color:#999;line-height: 25px;}
.education-part .caus-head-two{font-size: 30px;font-weight: 700;color:#111;font-family:'Roboto Slab';margin-bottom: 23px;}
...
.bg-1{background-color: #ff6d0d!important;}
...
.education-part .causes-detail .social-icon i:hover{background-color:#ff6d0d;color:#fff;}
...
.education-part .raised .pay-label{font-size: 14px;font-family: 'Roboto Slab';color: #10cb7f;font-weight: 600;margin-bottom: 20px;}
.education-part .raised .money{font-size: 14px;color: #999;font-weight: 400;font-family: 'Open Sans';}
.education-part .donate-box .donate-btn{color: #fff;background-color:#ff6d0d;padding:14px 31px 15px 30px;display: inline-block;font-size: 14px;font-weight: 500;text-decoration: none;margin-right: 15px;} 
/*End*/
...
.blog-detail-part .detail-part .title-two{font-size: 35px;color:#111;font-weight:700;font-family:'Roboto Slab';}
...
.blog-detail-part .tag-text{color:#111;background-color:#f1f1f1;font-family:'Roboto slab';padding:30px;font-style: italic;font-weight: 500;font-size: 17px;border-left: 2px solid #10cb7f;margin:28px 0px;}
.blog-detail-part .taged{margin: 30px 0 0px 0;}
.blog-detail-part .taged p{margin-bottom: 0;}
.blog-detail-part .taged strong{margin-right: 25px;font-size: 14px;font-weight: 500;font-family:'Roboto slab';}
.blog-detail-part .taged a{padding: 6px 19px;background-color:#f1f1f1;color:#999;margin: 0 5px;font-size: 14px;}
.blog-detail-part .taged a:hover{background-color:#ff6d0d;color: #fff!important;cursor: pointer;}
.blog-detail-part .blog-sec-line{border-top: 1px solid #e9e9e9;margin: 50px 0;}
.bloger-detail{padding: 0 100px;}
.bloger-detail .bloger-name{font-size: 18px;font-weight: 600;font-family:'Roboto slab';color:#111;margin-top: 20px;}
...
.bloger-detail .social-icon i:hover{background-color:#ff6d0d;color:#fff;}
.blog-part .related-three{font-size: 24px;color:#000;font-weight: 700;font-family:'Roboto Slab';margin-bottom: 25px;}
.comments-part .com-head-three{font-size: 24px;color:#000;font-weight: 700;font-family:'Roboto Slab';margin-bottom: 25px;}
...
.comments-part .comment .comment-detail .head-four{font-size: 18px;font-weight: 700;font-family: 'Roboto Slab';margin-bottom: 0;}
.comments-part .comment .comment-detail .reply-btn{padding: 10px 24px;background-color: #10cb7f;font-size: 14px;font-family:'Roboto Slab';color: #fff;text-decoration: none;position: absolute;right: 28px;top: 0;}
.comments-part .comment .comment-detail .reply-btn img{margin-left: 13px;}
.comm-form .comm-head-three{font-size: 26px;color:#111;font-family:'Roboto Slab';font-weight: 700;margin-bottom: 25px;}
...
.comm-form .btn.submit-comment{background-color: #10cb7f;color: #fff;font-weight: 700;font-family:'Roboto Slab';border-radius: 0;padding: 12px 43px;}
...
.item-info-stock .item-cat-col-qty .item-col-grp{margin-top: 25px;display: inline-block;color: #231f20;font-size: 16px;font-family:'Roboto Slab';margin-bottom: 15px;}
...
.item-detail .item-info .head-two{font-size: 24px;font-family:'Roboto Slab';font-weight: 600;}
...
.item-info-stock .item-count{color: #231f20;margin-bottom: 7px;font-size: 15px;font-family:'Roboto Slab';}
.item-info-stock .item-count .stock{color: #ff6d0d;margin-left: 5px;font-family:'Open Sans';}
.item-info-stock .item-cat-col-qty .item-no-group{width: 100%;}
.item-info-stock .item-cat-col-qty .item-no-group .item-no{margin-bottom: 7px;color:#231f20;font-size: 14px;font-family:'Roboto Slab';}
...
.item-info-stock .item-cat-col-qty .input-group .item-brand{margin-top: 8px;margin-right: 20px;font-size: 16px;font-family: 'Roboto Slab';color:#231f20;}
...
.item-contact .save-detail .detail-group .save-detail-info:hover  .item-detail-save,.item-contact .save-detail .detail-group .save-detail-info:hover a i{color:#ff6d0d;}
...
.item-detail .item-info .item-contact .social-icon i:hover{background-color:#ff6d0d;color: #fff;}
...
.tab-pane .nav-item-title{color: #333;font-family:'Roboto Slab',sans-serif;font-size: 14px;padding-top: 20px;}
.tab-pane{padding-left: 30px;}
.nav-tabs .nav-link{border-radius: 0;font-family: 'Roboto Slab',sans-serif;color:#333;border-bottom: 0;}
.related-prod-title .prod-title{font-size: 24px;font-family: 'Roboto Slab',sans-serif;color: #25262a;display: inline-block;padding-left: 15px;font-weight: 700;}
...
.related-prod .prod-item .prod-item-title a{color:#25262a;font-size: 16px;font-weight: 600;font-family:'Roboto Slab';}
...
.prod-edit .table th{font-family: Roboto Slab,sans-serif;font-weight: 500;}
.prod-edit .table .input-group input{width: 40px;border: 1px solid #cecece;text-align: center;vertical-align: middle;}
.prod-edit .table .prod-name{width: 520px;text-align: left!important;font-weight: 500;padding-left: 30px;font-size: 16px;font-weight: 700;font-family:'Roboto Slab';}
...
.shop-total .item-title,.shop-total .item-price.heading{font-family: 'Roboto Slab',sans-serif;font-weight: 500;}
.shop-total .item-title,{color:#3a424a;}
.shop-total .item-sub-total{color:#3a424a;font-size: 16px;}
.shop-total .item-price,.shop-total .item-total{font-size: 16px;color:#ff6d0d;}
.shop-total .checkout{float: right;display: inline-flex;margin-top: 10px;}
.shop-total .checkout a{background-color: #ff6d0d;color: #fff!important;padding: 15px 23px 14px;text-decoration: none;font-size: 14px;}
...
/*------End-----*/
    ...
    <footer class="footer-part">
        <div class="container" id="contact">
            <center><h1>Warehouse Management System(Free Ad Service)</h1><br><br><br></center>
            <br>
            <center><h2>Contact To Product Owner</h2></center><br>
            <h3>Product Owner - <b>Jay kakadiya &nbsp;&nbsp;&nbsp;  ph no-1234567890</b></h3>
            <h3>Product Owner - <b>Hardik Negi &nbsp;&nbsp;&nbsp;  ph no-1234567890</b></h3>
            <h3>Product Owner - <b>Kinjal Patel &nbsp;&nbsp;&nbsp;  ph no-1234567890</b></h3><br>
        </div>
    </footer>
    <!-- FOOTER END -->
    <!-- FOOTER SCRIPTS -->
